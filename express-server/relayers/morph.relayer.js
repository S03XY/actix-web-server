...
const { arbitrumSepolia, gnosisChiado, morphSepolia } = require("viem/chains");
...
const MorphRelayer = async () => {
  ...
  pubClient.watchContractEvent({
    abi: abi.abi,
    address: process.env.MORPH_RELAYER_CONTRACT,
    eventName: "ERelay",
    onLogs: async (logs) => {
